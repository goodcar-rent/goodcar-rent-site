    ...
    <div className={css.advWrapper}>
      ...
      <div className={css.advCards}>
        <div className={css.advCard}>
          <img className={css.advCardImg} src={img1}/>
        ...
        <div className={css.advCard}>
          <img className={css.advCardImg} src={img2}/>
        ...
        <div className={css.advCard}>
          <img className={css.advCardImg} src={img3}/>
        ...
        <div className={css.advCard}>
          <img className={css.advCardImg} src={img6}/>
